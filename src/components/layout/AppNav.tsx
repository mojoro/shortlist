      ...
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            aria-label="Settings"
            className={[
              "flex h-8 w-8 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--bg)] text-[var(--text-muted)] transition-all hover:border-[var(--border-strong)] hover:text-[var(--text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]",
            ].join(" ")}
          >
