        ...
        <div className="flex items-center gap-2">
          ...
          {isLoaded && isSignedIn ? (
            <>
              <Link
                href="/dashboard"
                className="inline-flex h-8 items-center gap-1 rounded-lg border border-[var(--border)] px-3.5 text-sm font-medium text-[var(--text-muted)] transition-colors hover:border-[var(--border-strong)] hover:text-[var(--text)]"
              >
                Dashboard
              ...
              <div ref={menuRef} className="relative">
                <button
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--accent)] text-xs font-bold text-[var(--accent-fg)] transition-opacity hover:opacity-90"
